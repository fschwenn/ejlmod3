...
jnls = [(1, ['aip3XXX.py', 'rsi', pryear-1929, prmonth]),
        ...
        (666, ['intlpress.py', 'jsg', pryear-2002, prquarter]), #journals_to_check_regularly_by_hand
        ...
        (111, ['theses-italy3.py', 'cagliarieprints']), #stoped 2016
        (3, ['theses-oslo.py']),
        (3, ['theses-naples.py']),
        ...
        (999999, ['theses-oregon.py']), #ist ja schon als python3 da
        (2, ['theses-brunel.py']),
        (3, ['theses-paraiba.py']),
        (2, ['theses-dart.py']),
