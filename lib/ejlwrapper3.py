...
#        (288, ['theses-oatd.py', '29', '31']), #proteced by Claudflare
        ...
        (111, ['sciencemag3.py', 'science', pryear]), #doppelt
        (2, ['theses-unesp3.py']),
        (111, ['sciencemag3.py', 'sciadv', pryear]), #doppelt
        (2, ['theses-eth3.py']),
        (2, ['theses-hub3.py']),
        (2, ['theses-mit3.py']),
        (1, ['theses-unibo3.py']),
...
#        (3333, ['npreview.py', pryear, prquarter]), #zu unregulaer
        (666, ['oxfordjournals.xml.py', 'integrablesystems', pryear-2015, '1']), # We regret to announce that Journal of Integrable Systems is no longer accepting submissions as the journal will be ceasing publication in 2020. 
