...
#        (666, ['theses-stonybrook.py']), #2017 eingeschlafen, https://commons.library.stonybrook.edu/ not yet ready?
        ...
        (2222, ['theses-unlp.py']), # python3-version schon in Liste
        (2, ['theses-dresden3.py']),
...
#        (3333, ['npreview.py', pryear, prquarter]), #zu unregulaer
        ...
        (3, ['indianjst3.py', pryear-2007]),
        (2, ['theses-waseda3.py']),
        (1, ['sciencemag3.py', 'research', pryear]),
        (1, ['plosone3.py']),
