...
jnls = [(1, ['aip3YYY.py', 'rsi', pryear-1929, prmonth]),
        ...
        (1, ['theses-carleton3XXX.py']),
        (1, ['theses-duke3XXX.py']),
        ...
        (2, ['theses-baylor3XXX.py']),
        (1, ['theses-mcgill3.py']),
        (2, ['theses-uclondon3.py']),
        (1, ['theses-italy3XXX.py', 'milanbicocca']),
...
#        (666, ['theses-stonybrook.py']), #2017 eingeschlafen, https://commons.library.stonybrook.edu/ not yet ready?
        ...
        (1, ['theses-rome3.py']),
        (1, ['theses-lund3.py']),
        (1, ['theses-italy3XXX.py', 'trento']),
        (1, ['theses-italy3XXX.py', 'pavia']),
        (1, ['theses-italy3XXX.py', 'turinpoly']),
        (1, ['theses-italy3XXX.py', 'milan']),
        (1, ['theses-italy3XXX.py', 'udine']),
        (1, ['theses-italy3XXX.py', 'genoa']),
        (2, ['theses-italy3XXX.py', 'ferrara']),
        (2, ['theses-italy3XXX.py', 'siena']),
        (2, ['theses-italy3XXX.py', 'verona']),
        (1, ['theses-italy3XXX.py', 'cagliari']),
        (1, ['theses-italy3XXX.py', 'sns']),
        (1, ['theses-naples3.py']),
        ...
        (2, ['theses-hawaii3.py']),
        (3, ['theses-porto3.py']),
        (3, ['edpjournals3XXX.py', '4open', pryear, '1']),
        (1, ['theses-tuwien3.py']),
