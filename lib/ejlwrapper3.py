...
#max number of xml files to report per python program
writtenfilesmax = 5
#get previous month
if len(sys.argv) == 4:
...
jnls = [(1, ['aip3.py', 'rsi', pryear-1929, prmonth]),
        ...
        (3, ['aip3.py', 'apq', pryear-2023, prquarter]),
        (1, ['aip3.py', 'cha', pryear-1990, prmonth]),
        (2, ['aip3.py', 'jvb', pryear-1982, prsixth]),
        (1, ['aip3.py', 'ltp', pryear-1974, prmonth]),
        (1, ['aip3.py', 'php', pryear-1993, prmonth]),
        (1, ['aip3.py', 'adv', pryear-2010, prmonth]),
        ...
        (3, ['theses-oregon3.py']),
        (2, ['theses-aachen3.py']),
        (2, ['theses-oatd3YYY.py', '0', '5']), #proteced by Claudflare
        (2, ['theses-oatd3YYY.py', '5', '10']), #proteced by Claudflare
        (2, ['theses-oatd3YYY.py', '10', '15']), #proteced by Claudflare
        (2, ['theses-oatd3YYY.py', '15', '20']), #proteced by Claudflare
        (2, ['theses-oatd3YYY.py', '20', '25']), #proteced by Claudflare
        (2, ['theses-oatd3YYY.py', '25', '30']), #proteced by Claudflare
        (2, ['theses-oatd3YYY.py', '30', '35']), #proteced by Claudflare
        (1, ['mdpi.sftp3.py', 'symmetry']),
        (1, ['mdpi.sftp3.py', 'sensors']),
        (1, ['cjp3XXX.py', 'cjp', pryear-1922, prmonth]),
        (1, ['mdpi.sftp3.py', 'nanomaterials']),
        (12, ['annualreview3XXX.py', 'arnps', pryear-1950]),
        (12, ['annualreview3XXX.py', 'araa', pryear-1962]),
        ...
        (2, ['theses-nikhef3.py']),
        (2, ['theses-clas3.py']),
        (1, ['theses-kentucky3.py']),
        (1, ['theses-italy3.py', 'sissa']),
        (1, ['theses-maryland3.py']),
        (1, ['figshare3.py', 'ryerson']),
        (2, ['theses-belle3.py']),
        (2, ['theses-CSUC3.py']),
        (1, ['theses-cambridge3.py']),
        (1, ['theses-pennstate3.py']),
        (2, ['theses-DCN3.py']),
        (2, ['theses-PANDA3.py']),
        ...
        (12, ['annualreview3XXX.py', 'arcmp', pryear-2009]),
        (2, ['theses-kit_etp3.py']),
        (1, ['mdpi.sftp3.py', 'atoms']),
        (3, ['spie_journal3XXX.py', 'jatis', pryear-2014, prquarter]),
        ...
        (1, ['sciencemag3YYY.py', 'science', pryear]),
        (1, ['theses-uam3.py']),
        (2, ['theses-durham3.py']),
        (1, ['sciencemag3YYY.py', 'sciadv', pryear]),
        (2, ['theses-southampton3.py']),
        (1, ['theses-imperial3YYY.py']),
        (2, ['theses-bern3.py']),
        (1, ['theses-edinburgh3.py']),
        (2, ['theses-kyoto3.py']),
        (1, ['theses-tud3.py']),
        (1, ['theses-surrey3.py']),
        (1, ['theses-lmu3.py']),
        ...
        (222, ['theses-victoria3.py']), # now at figshare
        ...
        (1, ['theses-arizona3.py']),
        (1, ['theses-carleton3.py']),
        (1, ['theses-duke3.py']),
        ...
        (1, ['theses-freiburg3.py']),
        (2, ['theses-montreal3.py']),
        (1, ['theses-hamburg3.py']),
        (2, ['theses-nielsbohr3.py']),
        (2, ['theses-pittsburgh3.py']),
        (2, ['theses-unlp3.py']),
        (1, ['theses-simonfraser3.py']),
        (1, ['theses-liverpool3.py']),
        (2, ['theses-baylor3.py']),
        (1, ['theses-mcgill3.py']),
        (2, ['theses-uclondon3.py']),
        (1, ['theses-italy3.py', 'milanbicocca']),
        (2, ['theses-adelaide3.py']),
        (1, ['theses-glasgow3.py']),
        (1, ['theses-siegen3.py']),
        (1, ['theses-basel3.py']),
        (1, ['theses-britishcolumbia3.py']),
        ...
        (1, ['theses-tel3.py']),
        (2, ['figshare3.py', 'sussex']),
        (2, ['theses-federicosantamaria3.py']),
        (1, ['theses-hannover3.py']),
#        (666, ['theses-stonybrook.py']), #2017 eingeschlafen, https://commons.library.stonybrook.edu/ not yet ready?
        ...
        (2, ['theses-southermethodist3.py']),
        (1, ['theses-tubingen3.py']),
        (2, ['theses-waynestate3.py']),
        (1, ['theses-thueringen3.py']),
        ...
        (2, ['theses-vtech3.py']),
        (2, ['theses-vcommonwealth3.py']),
        (3, ['comaphy3.py', pryear-1998, prquarter]),
        (2, ['theses-qucosa3.py', 'dresden']),
        ...
        (1, ['theses-rome3.py']),
        (1, ['theses-lund3.py']),
        (1, ['theses-italy3.py', 'trento']),
        (1, ['theses-italy3.py', 'pavia']),
        (1, ['theses-italy3.py', 'turinpoly']),
        (1, ['theses-italy3.py', 'milan']),
        (1, ['theses-italy3.py', 'udine']),
        (1, ['theses-italy3.py', 'genoa']),
        (2, ['theses-italy3.py', 'ferrara']),
        (2, ['theses-italy3.py', 'siena']),
        (2, ['theses-italy3.py', 'verona']),
        (1, ['theses-italy3.py', 'cagliari']),
        (1, ['theses-italy3.py', 'sns']),
        (1, ['theses-naples3.py']),
        (2, ['theses-cantabria3.py']),
        (2, ['theses-coimbra3.py']),
        (2, ['theses-salerno3.py']),
        (2, ['theses-kamiokande3.py']),
        (2, ['theses-louvain3.py']),
        (2, ['theses-graz3.py']),
        (2, ['theses-osaka3.py']),
        (2, ['theses-kingscollege3.py']),
        (3, ['theses-okayama3.py']),
        (1, ['theses-italy3.py', 'parma']),
        (2, ['theses-washington3.py']),
        (1, ['theses-queenmary3.py']),
        (1, ['theses-trinity3.py']),
        (3, ['theses-jyvaskyla3.py']),
        (1, ['theses-manitoba3.py']),
        (2, ['theses-canterbury3.py']),
        ...
        (2, ['theses-oslo3.py']),
        (1, ['theses-arizona_u3.py']),
        (1, ['theses-geneve3.py']),
        (2, ['theses-hawc3.py']),
        (2, ['theses-concepcion3.py']),
        ...
        (3, ['ljp3.py']),
        (1, ['acs3YYY.py', 'nalefd', pryear-2000, prmonth]),
        (2, ['scipost3.py', 'spsln']),
        (2, ['theses-italy3.py', 'trieste']),
        (1, ['acs3YYY.py', 'apchd5', pryear-2013, prmonth]),
        ...
        (2, ['theses-waseda3.py']),
        (1, ['sciencemag3YYY.py', 'research', pryear]),
        (1, ['plosone3.py']),
        ...
        (1, ['aip3.py', 'app', pryear-2015, prmonth]),
        (1, ['theses-bilbao3.py']),
        ...
        (2, ['theses-italy3.py', 'padua']),
        (2, ['theses-italy3.py', 'messina']),
        (2, ['theses-stavanger3.py']),
        (2, ['theses-riograndedonorte3.py']),
        (1, ['theses-ulm3.py']),
        (2, ['theses-italy3.py', 'aquila']),
        (1, ['theses-italy3.py', 'florence']),
        (2, ['theses-juizdefora3.py']),
        (1, ['theses-msu3.py']),
        (2, ['theses-qucosa3.py', 'chemnitz']),
        (2, ['theses-qucosa3.py', 'leipzig']),
        (2, ['theses-elpaso3.py']),
        (1, ['theses-msu3.py']),
        (2, ['siam3YYY.py', 'sjmaah', pryear-1968, prsixth]),
        (2, ['siam3YYY.py', 'sjoce3', pryear-1978, prsixth]),
        (2, ['degruyterjournals3.py', 'form', pryear, pryear-1988, prsixth]),
        (3, ['degruyterjournals3.py', 'jnet', pryear, pryear-1975, prquarter]),
        (3, ['siam3YYY.py', 'siread', pryear-1958, prquarter]),
        (2, ['siam3YYY.py', 'smjcat', pryear-1971, prsixth]),
        (1, ['rinton3.py', 'qic']),
        (2, ['siam3YYY.py', 'smjmap', pryear-1940, prsixth]),
        (3, ['aip3.py', 'apr', pryear-2013, prquarter]),
        (3, ['siam3YYY.py', 'sjmael', pryear-1979, prquarter]),
        (2, ['siam3YYY.py', 'sjnaam', pryear-1962, prsixth]),
#        (222, ['degruyterjournals3.py', 'ms', pryear, pryear-1950, prsixth]), #now in list to be checked by hand
        ...
        (3, ['siam3YYY.py', 'sjdmec', pryear-1986, prquarter]),
        (2, ['princetonbooks3XXX.py']),
        (3, ['siam3YYY.py', 'sjaabq', pryear-2016, prquarter]),
        (2, ['muse3.py', '5']),
        (3, ['osa3.py', 'aop', pryear-2008, prquarter]),
        (1, ['rsc3.py', 'cp', pryear-1998, prmonth*4]),
        (2, ['tandfbooks3.py', 'SCPC']),
        (1, ['rsc3.py', 'cp', pryear-1998, prmonth*4-1]),
        (2, ['tandfbooks3.py', 'SCMA']),
        (1, ['rsc3.py', 'cp', pryear-1998, prmonth*4-2]),
        (2, ['tandfbooks3.py', 'SCCM']),
        (1, ['rsc3.py', 'cp', pryear-1998, prmonth*4-3]),
        (3, ['aip3.py', 'aml', pryear-2022, prquarter]),
        (3, ['theses-embryriddle3.py']),
        (1, ['theses-bremen3.py']),
        (2, ['aip3.py', 'mre', pryear-2015, prsixth]),
...
if (today.day % 3 == 0):
    listofcommands.append(['wsp3YYY.py'])
    prfil.write(' - wsp3YYY.py\n')
elif (today.day % 3 == 1):
    listofcommands.append(['ieee_wrapper3YYY.py'])
    prfil.write(' - ieee_wrapper3YYY.py\n')
elif (today.day % 3 == 2):
    ...
    if re.search('(XXX|YYY)\.py', com[0]):
        ...
        for line in re.split('\n', result):
            if refin.search(line):
                writtenfilestmp.append(refin.sub(r'   \1.xml (\2 records)\n   [records with datafields: \3]', line))
        if len(writtenfilestmp) < writtenfilesmax:
            writtenfiles += writtenfilestmp
            writtenfiles.append('\n\n')
        else:
            writtenfiles.append('  dropped reporting of %i xml files' % (len(writtenfilestmp) - writtenfilesmax))
            writtenfiles += writtenfilestmp[-writtenfilesmax:]
            writtenfiles.append('\n\n')
