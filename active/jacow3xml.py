...
sourceurl = 'https://jacow.org/%s/html/inspire-%s.xml' % (acronym, acronym)
#sourceurl = 'https://www.desy.de/~schwenn/inspire-IPAC2023.xml'
print(sourceurl)
...
#sourcesoup = BeautifulSoup(urllib.request.urlopen(req, timeout=300), features="lxml")
driver.get(sourceurl)
sourcesoup = BeautifulSoup(driver.page_source, features="lxml")
