...
for page in range(pages):
    tocurl = 'http://bibliotecavirtual.dgb.umich.mx:8083/xmlui/handle/DGB_UMICH/3/discover?rpp=' + str(rpp) + '&etal=0&group_by=none&page=' + str(page+1) + '&sort_by=dc.date.issued_dt&order=desc'
