...
startpage = BeautifulSoup(urllib.request.urlopen(starturl, timeout=300), features="lxml")
...
#read TOC
recs = []
tocpage = BeautifulSoup(urllib.request.urlopen(tocurl, timeout=300), features="lxml")
